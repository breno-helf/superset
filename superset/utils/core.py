...
def pessimistic_connection_handling(some_engine: Engine) -> None:
    # In SQLAlchemy 2.0, the recommended approach for pessimistic disconnect
    # handling is pool_pre_ping=True on the engine. Enable it here so
    # existing callers continue to work without changes.
    some_engine.pool._pre_ping = True  # noqa: SLF001
