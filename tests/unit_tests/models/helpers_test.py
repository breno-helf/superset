...
def test_orderby_saved_metric_takes_precedence_over_adhoc_column_label(
    database: Database,
) -> None:
    """
    Test that orderby resolves to the stored metric when a stored metric and
    an adhoc column share the same label.
    """
