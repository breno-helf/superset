...
def test_orderby_stored_metric_takes_precedence_over_adhoc_column(
    database: Database,
) -> None:
    """
    Test that when an adhoc column label collides with a stored metric name,
    the stored metric wins in the orderby resolution chain.
    """
